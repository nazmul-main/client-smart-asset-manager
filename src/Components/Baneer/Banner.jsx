...
const Banner = () => {
  ...
  return (
    <div className="relative max-w-screen-xl md:mx-auto mx-8">
      <Slider {...settings} >
        {/* Slide 1 */}
        <div className='relative h-[80vh]'>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
            <Link to='/joinEmploye' className="bg-green-700 text-white px-2 py-3 rounded">
              Join As Employee
            </Link>
          </div>
        </div>
        ...
        <div className='relative h-[80vh]'>
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-black opacity-70"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
            <Link to='/joinAdminHR' className="bg-green-700 text-white px- py-3 rounded">
              Join as HR/Admin
            </Link>
          </div>
        </div>
